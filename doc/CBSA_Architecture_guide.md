...
## The Payment and Customer Services (Spring Boot) User Interface
...
- That there is a Liberty JVM (installed as part of the Carbon React UI
  installation)

- That there is a z/OS Connect server (installed as part of the base
  installation)
