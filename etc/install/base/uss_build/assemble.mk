...
help-assemble:
	...
	@echo "  assemble-maps    - Assemble all BMS maps"
	@echo "  clean-assemble   - Remove assembly artifacts"
	@echo "  list-maps        - List all BMS maps"
	@echo "  status-assemble  - Show assembly status"
	@echo ""
	@echo "Examples:"
	@echo "  gmake assemble-maps                    # Assemble all maps"
	@echo "  gmake $(BMS_MACRO_DIR)/BNK1ACC.cpy     # Assemble BNK1ACC only"
	@echo "  gmake -j4 assemble-maps                # Assemble with 4 parallel jobs"
	@echo "  gmake clean-assemble assemble-maps     # Clean and reassemble all"
	@echo ""
	@echo "BMS Maps: $(words $(BMS_MAPS))"
	@echo ""
	@echo "Build directories:"
	@echo "  BMS Source: $(BMS_SRC_DIR)"
	@echo "  Macros:     $(BMS_MACRO_DIR)"
	@echo ""
	@echo "Note: Generated copybooks are placed in $(BMS_MACRO_DIR)"
	@echo ""
